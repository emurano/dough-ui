...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: createInputObject(['src/main.ts', 'src/components/**/index.{ts,tsx}', 'src/layout-primitives/**/index.{ts,tsx}', 'src/providers/**/index.{ts,tsx}', 'src/hooks/**/index.{ts,tsx}', 'src/page-layouts/**/index.{ts,tsx}', 'src/internal/**/index.{ts,tsx}', 'src/type/**/index.{ts,tsx}']),
      output: {
  ...
  test: {
    ...
    coverage: {
      provider: 'istanbul',
      include: ['src/**/*'],
      exclude: ['./src/**/*.stories.ts', './src/**/*.stories.tsx', './src/**/*.test.ts', './src/**/*.test.tsx', '**/*/__tests__', '**/*/__stories__', './src/stories/**/*', './src/type/**/*']
    },
    projects: [{
      extends: true,
      plugins: [
